  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-10 overflow-hidden">
      ...
      <style jsx global>{`
        ...
        .butterfly-core {
          animation: butterfly-bob 3.2s ease-in-out infinite;
          transform-origin: center;
        }
        ...
        .butterfly-right {
          animation-name: butterfly-rise-right;
        }

        .butterfly-left {
          animation-name: butterfly-rise-left;
        }

        @keyframes butterfly-rise-right {
          0% {
          ...
          50% {
            transform: translate3d(0, 45vh, 0) rotate(6deg);
            opacity: 0.9;
          }
          92% {
            opacity: 0.65;
        ...
        @keyframes butterfly-flap {
          ...
          50% {
            transform: scaleX(0.74) scaleY(1.22) rotate(1deg);
          }
        }
